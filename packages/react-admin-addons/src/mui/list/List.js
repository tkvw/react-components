...
import queryReducer, {
    ...
    SET_FILTER,
    SORT_DESC,
} from 'react-admin/lib/reducer/admin/resource/list/queryReducer';
import DefaultActions from 'react-admin/lib/mui/list/ListActions';
import removeKey from 'react-admin/lib/util/removeKey';
...
function mapStateToProps(state, props) {
    ...
    const addonsState = state.addons.resources[props.resource];
    return {
        ...
        selectedIds: addonsState.list.selection.ids,
